...
<form method="post">
    <div class="row">
        <div class="col-4"></div>
        <div class="col-4 "><input name="login" class="rounded-input" type="text" placeholder="Логин"
                                   style="width:100%;"/>
        </div>
        <div class="col-4"></div>
    </div>
    <div class="row" style="margin-top: 0.7%;">
        <div class="col-4"></div>
        <div class="col-4 "><input name="password" class="rounded-input" type="password" placeholder="Пароль"
                                   style="width:100%;"/></div>
        <div class="col-4"></div>
    </div>
    <div class="row" style="margin-top: 0.7%;">
